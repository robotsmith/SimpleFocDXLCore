...
unsigned short crc_conversion(unsigned short crc_accum, unsigned char *data_blk_ptr, unsigned short data_blk_size) // http://support.robotis.com/en/product/actuator/dynamixel_pro/communication/crc.htm
{
  unsigned short i, j;
