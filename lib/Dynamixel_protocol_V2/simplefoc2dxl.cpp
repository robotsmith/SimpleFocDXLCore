...
simplefoc_dxl_servo::simplefoc_dxl_servo(BLDCMotor *_motor, dynamixelDevice *_dxl)
{
  motor = _motor;
  dxl = _dxl;
}
void simplefoc_dxl_servo::update()
{
  // Simple foc
...
void simplefoc_dxl_servo::update_parameters()
{
